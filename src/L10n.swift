...
extension Strings {
    static let spanish = Strings(
        ...
        autoOffOnConnect: "      Apagarla siempre al conectar una externa",
        restoreOff: "Mantener mi configuración al despertar/arrancar",
    ...
    static let english = Strings(
        ...
        autoOffOnConnect: "      Always turn it off when an external connects",
        restoreOff: "Keep my setup after wake/startup",
